...
public class MusicPlayerLibraryDemoFragment extends Fragment
  ...
  public void onAlbumClicked(View view, Album album) {
    MusicPlayerAlbumDemoFragment fragment = MusicPlayerAlbumDemoFragment.newInstance(album.id);
  ...
  private RecyclerView createRecyclerView(boolean listTypeGrid) {
    ...
    int verticalPadding =
        context
            .getResources()
            .getDimensionPixelSize(R.dimen.cat_music_player_album_list_padding_vertical);
