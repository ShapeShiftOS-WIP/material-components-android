 ...
 *
 * @attr ref com.bottombar.navigation.material.R.styleable#SingleSlider_android_value
 */
public class Slider extends BaseSlider<Slider, OnChangeListener, OnSliderTouchListener> {
   ...
   *
   * @see #setValue(float)
   * @attr ref com.bottombar.navigation.material.R.styleable#Slider_android_value
   */
