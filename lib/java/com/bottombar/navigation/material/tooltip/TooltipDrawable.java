...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableDelegate {
   ...
   *
   * @attr ref com.bottombar.navigation.material.R.styleable#Tooltip_android_text
   */
  @Nullable
   ...
   *
   * @attr ref com.bottombar.navigation.material.R.styleable#Tooltip_android_textAppearance
   */
  @Nullable
   ...
   *
   * @see #setMinWidth(int)
   * @attr ref com.bottombar.navigation.material.R.styleable#Tooltip_android_minWidth
   */
   ...
   * @attr ref com.bottombar.navigation.material.R.styleable#Tooltip_android_minHeight
   */
   ...
   * @attr ref com.bottombar.navigation.material.R.styleable#Tooltip_android_padding
   */
   ...
   * @attr ref com.bottombar.navigation.material.R.styleable#Tooltip_android_layout_margin
   */
