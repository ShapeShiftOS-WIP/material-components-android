...
public class BadgeDrawable extends Drawable implements TextDrawableDelegate {
   ...
   * @attr ref com.bottombar.navigation.material.R.styleable#Badge_backgroundColor
   */
  @ColorInt
   ...
   * @attr ref com.bottombar.navigation.material.R.styleable#Badge_badgeTextColor
   */
  @ColorInt
   ...
   *
   * @see #setNumber(int)
   * @attr ref com.bottombar.navigation.material.R.styleable#Badge_number
   */
   ...
   * @attr ref com.bottombar.navigation.material.R.styleable#Badge_maxCharacterCount
   */
