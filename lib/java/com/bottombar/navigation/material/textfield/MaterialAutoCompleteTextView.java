...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
   ...
   * @see #setSimpleItems(int)
   * @attr ref
   *     com.bottombar.navigation.material.R.styleable#MaterialAutoCompleteTextView_simpleItemSelectedColor
   */
   ...
   * @see #setSimpleItems(int)
   * @attr ref
   *     com.bottombar.navigation.material.R.styleable#MaterialAutoCompleteTextView_simpleItemSelectedRippleColor
   */
   ...
   *
   * @attr ref
   *     com.bottombar.navigation.material.R.styleable#MaterialAutoCompleteTextView_android_popupElevation
   */
